...
location = (0, 0, 0.025907) # (GUI: click mesh > Transform > Location)
rotation = (77, 12.1, -228) # (GUI: click mesh > Transform > Rotation)
scale = (0.01,0.01,0.01) # (GUI: click mesh > Transform > Scale)
