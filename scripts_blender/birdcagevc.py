...
name = "birdcage"
meshPath = '../comparison_results/voxelcores_birdcage.obj'.format(name)
outputPath = os.path.join(cwd, './{}vc.png'.format(name))
imgRes_x = 2048 # recommend > 1080 
imgRes_y = 2048 # recommend > 1080 
numSamples = 400 # recommend > 200
location = (0, 0, 0.98) # (GUI: click mesh > Transform > Location)
rotation = (85.1, 16.2, -198) # (GUI: click mesh > Transform > Rotation)
scale = (0.76,0.76,0.76) # (GUI: click mesh > Transform > Scale)
