...
if len(argv) > 1:
    ...
    if method == 'coverage':
        ...
        if method == 'l1':
            endpng = 'l1'
            meshPath = '../comparison_results/l1/{}.skel_l1.obj'.format(name)
        else :
            method = "Sine"
            endpng = ''
...
location = (0,0,0.80867) # (GUI: click mesh > Transform > Location)
rotation = (65,0,90) # (GUI: click mesh > Transform > Rotation)
scale_unif = 0.757
