...
meshPath = '../comparison_results/voxelcores_{}.obj'.format(name)
imgRes_x = 2048 # recommend > 1080 
imgRes_y = 2048 # recommend > 1080 
numSamples = 400 # recommend > 200
location = (-0.20291, 0, 0.87277) # (GUI: click mesh > Transform > Location)
rotation = (90, 0, 0) # (GUI: click mesh > Transform > Rotation)
scale_unif = 0.808
