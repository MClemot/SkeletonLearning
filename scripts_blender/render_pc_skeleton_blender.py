...
name = "guitar"
outputPath = os.path.join(cwd, './guitar.png')
...
make_spheres(bpy.data.objects, bpy.context, mesh)
...
ptSize = 0.01
bt.setMat_pointCloud(mesh2, meshColor2, ptSize, 0.4, 1)

#print("adding spheres to mesh vertices")
#make_spheres_pc(bpy.data.objects, bpy.context, mesh2)
#print("done")
