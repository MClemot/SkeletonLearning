...
location = (0, 0, 0.4788) # (GUI: click mesh > Transform > Location)
rotation = (90, 0, -37.4) # (GUI: click mesh > Transform > Rotation)
scale_unif = 1
...
scale2 = (0.5,0.5,0.5) # (GUI: click mesh > Transform > Scale)
mesh2 = bt.readMesh(meshPath2, location, rotation, scale2)
